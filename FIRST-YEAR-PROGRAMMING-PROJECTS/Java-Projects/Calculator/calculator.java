...
public class calculator implements ActionListener{
	...
	JPanel panel;
    JToggleButton modeToggleButton;
	...
	calculator(){
        ...
        modeToggleButton = new JToggleButton("Mode");


        modeToggleButton.setBounds(150, 500, 100, 50);
        modeToggleButton.addActionListener(this);
	...
	public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == modeToggleButton){
            isDarkMode = modeToggleButton.isSelected();
            updateMode();
        }
